...
const movies = [
    ...
    movies.forEach(movie => {       // Code for going through each movie and creating content for that movie:
    
    const article = document.createElement('article');
    article.className = 'movie';    //creates the article with the class: 'movie'
